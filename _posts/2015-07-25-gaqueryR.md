---
title: R tutorial- Google Analytics API part 1
---

Exporting your data from Google Analytics is great when you want to customize your visualizations, in addition to pulling more insights that you otherwise can't access.

I often pull data in R before routing it back into tableau because R offers more control over how I want the data to look.
